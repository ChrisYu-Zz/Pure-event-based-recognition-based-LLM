...
file_path = 'E2HQV-Caltech-8-25-f21-groundtruth.txt'
...
#
#
file_type = "E2HQV-Caltech-f2o-394"

for image_folder in os.listdir("E2HQV-Caltech-f2o-394"):
    images_file="E2HQV-Caltech-f2o-394/"+image_folder
    images_list=[]
    ...
    for i in range(len(images_list)):
        ...
        messages[0]["content"].append(
            {"type": "image_url", "image_url": {
                "url": f"https://env-00jxh60u5ok0.normal.cloudstatic.cn/eventgpt/E2HQV-Caltech-f2o-394/{images_list[i]}"}}
        )
    ...
    while True:
        try:
            ...
            print(answer)
            print("--------------------------------------------------------------------------")
            with open('Result-4o-'+file_type+'.txt', 'a', encoding='utf-8') as file:
                file.write(answer + '\n')
            break
...
with open('Result-4o-'+file_type+'.txt', 'r', encoding='utf-8') as file:
    content = file.read()
...
groundtruth_dict={}
with open("E2HQV-Caltech-8-25-f21-groundtruth.txt") as f:
    for line in f:
        line = line.strip()
        if line:
