...
file_path = './Gray-Caltech-8-25-f21-groundtruth.txt'
...
#
#
file_type = "Gray-Caltech-f2o-394"

for image_folder in os.listdir("Gray-Caltech-f2o-394"):
    images_file="Gray-Caltech-f2o-394/"+image_folder
    images_list=[]
    ...
    for i in range(len(images_list)):
        ...
        messages[0]["content"].append(
            {"type": "image_url", "image_url": {
                "url": f"https://env-00jxh60u5ok0.normal.cloudstatic.cn/eventgpt/Gray-Caltech-f2o-394/{images_list[i]}"}}
        )
...
groundtruth_dict={}
with open("Gray-Caltech-8-25-f21-groundtruth.txt") as f:
    for line in f:
        line = line.strip()
        if line:
