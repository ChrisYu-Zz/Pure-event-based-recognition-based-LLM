...
file_path = 'E2HQV-ImageNet-f2o-groundtruth.txt'
...
#
#
file_type = "E2HQV-ImageNet-f2o-2000"

for image_folder in os.listdir("E2HQV-ImageNet-f2o-2000"):
    images_file="E2HQV-ImageNet-f2o-2000/"+image_folder
    images_list=[]
    ...
    for i in range(len(images_list)):
        ...
        messages[0]["content"].append(
            {"type": "image_url", "image_url": {
                "url": f"https://mp-ce6aedf9-67f1-428d-8f5a-23b74c183be4.cdn.bspapp.com/E2HQV-ImageNet-f2o-2000/{images_list[i]}"}}
        )
    while True:
        try:
...
groundtruth_dict={}
with open("E2HQV-ImageNet-f2o-groundtruth.txt") as f:
    for line in f:
        line = line.strip()
        if line:
            entry = eval(line)
