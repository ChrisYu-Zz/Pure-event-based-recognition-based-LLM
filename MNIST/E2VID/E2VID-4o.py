...
file_path = 'E2VID-MNIST-t2o-groundtruth.txt'
...
#
#
file_type = "E2VID-MNIST-t2o-327"

for image_folder in os.listdir("E2VID-MNIST-t2o-327"):
    images_file="E2VID-MNIST-t2o-327/"+image_folder
    images_list=[]
    ...
    for i in range(len(images_list)):
        ...
        messages[0]["content"].append(
            {"type": "image_url", "image_url": {
                "url": f"https://mp-ce6aedf9-67f1-428d-8f5a-23b74c183be4.cdn.bspapp.com/E2VID-MNIST-t2o-327/{images_list[i]}"}}
        )
...
groundtruth_dict={}
with open("E2VID-MNIST-t2o-groundtruth.txt") as f:
    for line in f:
        line = line.strip()
        if line:
            entry = eval(line)
